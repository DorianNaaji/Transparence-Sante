...
package transparence_sante_bi.specialite_beneficiaire_dim_0_1;
...
/**
 * Job: specialite_beneficiaire_dim Purpose: Remplissage de la dimension de
 * spécialité des bénéficiaires<br>
 * Description: Les bénéficiaires possèdent des spécialités (en médecine) qui
 * sont recensées dans les fichiers. Cette dimension les contiendra. Voir doc :
 ...
 * @status DEV
 */
public class specialite_beneficiaire_dim implements TalendJob {
	...
	private final String jobName = "specialite_beneficiaire_dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					specialite_beneficiaire_dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(specialite_beneficiaire_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		...
		public String specialite_beneficiaire_nom;

		public String getSpecialite_beneficiaire_nom() {
			return this.specialite_beneficiaire_nom;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim.length) {
					if (length < 1024
							&& commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim.length == 0) {
						commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[1024];
					} else {
						commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim, 0, length);
				strReturn = new String(commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim) {
				...
				try {
					...
					this.specialite_beneficiaire_nom = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.specialite_beneficiaire_nom, dos);
		...
		public String toString() {
			...
			sb.append(",specialite_beneficiaire_nom=" + specialite_beneficiaire_nom);
			sb.append("]");
	...
	public static class specialitesStruct implements routines.system.IPersistableRow<specialitesStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(specialitesStruct other) {
	...
	public static class specialites_remunerationsStruct
			implements routines.system.IPersistableRow<specialites_remunerationsStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(specialites_remunerationsStruct other) {
	...
	public static class specialites_avantagesStruct
			implements routines.system.IPersistableRow<specialites_avantagesStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(specialites_avantagesStruct other) {
	...
	public static class specialites_conventionsStruct
			implements routines.system.IPersistableRow<specialites_conventionsStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_specialite_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(specialites_conventionsStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				specialites_remunerationsStruct specialites_remunerations = new specialites_remunerationsStruct();

				avantagesStruct avantages = new avantagesStruct();
				specialites_avantagesStruct specialites_avantages = new specialites_avantagesStruct();

				conventionsStruct conventions = new conventionsStruct();
				specialites_conventionsStruct specialites_conventions = new specialites_conventionsStruct();

				mergedStruct merged = new mergedStruct();
				filteredStruct filtered = new filteredStruct();
				specialitesStruct specialites = new specialitesStruct();
				...
				util_tLogRow_1.addRow(new String[] { "specialite_beneficiaire_id", "specialite_beneficiaire_nom", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "specialites");
				}
				...
				String tableName_tDBOutput_1 = "specialite_beneficiaire_dim";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:cZm1aOx0fj8+fDh93m+l7aU8Rp9oDS/D0Q6WCw==");
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "specialite_beneficiaire_dim"
						+ "` (`specialite_beneficiaire_id`,`specialite_beneficiaire_nom`) VALUES (?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					String specialite_beneficiaire_id;
					String specialite_beneficiaire_nom;
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.specialite_beneficiaire_id == null) ? 0
									: this.specialite_beneficiaire_id.hashCode());

							result = prime * result + ((this.specialite_beneficiaire_nom == null) ? 0
									: this.specialite_beneficiaire_nom.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.specialite_beneficiaire_id == null) {
							if (other.specialite_beneficiaire_id != null)
								return false;

						} else if (!this.specialite_beneficiaire_id.equals(other.specialite_beneficiaire_id))

							return false;

						if (this.specialite_beneficiaire_nom == null) {
							if (other.specialite_beneficiaire_nom != null)
								return false;

						} else if (!this.specialite_beneficiaire_nom.equals(other.specialite_beneficiaire_nom))
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "specialites_avantages",
							"specialites_remunerations", "specialites_conventions");
				}
...
// # Outputs initialization
				specialites_remunerationsStruct specialites_remunerations_tmp = new specialites_remunerationsStruct();
// ###############################
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									remunerations.remu_montant_ttc = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
// Start of branch "remunerations"
						if (remunerations != null) {
							...
							{ // start of Var scope
								...
								specialites_remunerations = null;

// # Output table : 'specialites_remunerations'
								specialites_remunerations_tmp.specialite_beneficiaire_id = remunerations.benef_specialite_code
										.equals("") ? null : remunerations.benef_specialite_code;
								specialites_remunerations_tmp.specialite_beneficiaire_nom = remunerations.benef_speicalite_libelle
										.equals("") ? null : remunerations.benef_speicalite_libelle;
								specialites_remunerations = specialites_remunerations_tmp;
// ###############################
							 ...
							 */
// Start of branch "specialites_remunerations"
							if (specialites_remunerations != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "specialites_remunerations");
								}
...
// for output
								...
								merged.specialite_beneficiaire_id = specialites_remunerations.specialite_beneficiaire_id;
								merged.specialite_beneficiaire_nom = specialites_remunerations.specialite_beneficiaire_nom;
...
//////////
								...
								ope_tFilterRow_1.matches((merged.specialite_beneficiaire_id != null),
										"specialite_beneficiaire_id!=null failed");
								ope_tFilterRow_1.matches((merged.specialite_beneficiaire_nom != null),
										"specialite_beneficiaire_nom!=null failed");

								if (ope_tFilterRow_1.getMatchFlag()) {
									if (filtered == null) {
										filtered = new filteredStruct();
									}
									filtered.specialite_beneficiaire_id = merged.specialite_beneficiaire_id;
									filtered.specialite_beneficiaire_nom = merged.specialite_beneficiaire_nom;
...
// Start of branch "filtered"
								if (filtered != null) {
									...
									specialites = null;
									if (filtered.specialite_beneficiaire_id == null) {
										finder_tUniqRow_1.specialite_beneficiaire_id = null;
									} else {
										finder_tUniqRow_1.specialite_beneficiaire_id = filtered.specialite_beneficiaire_id
												.toLowerCase();
									}
									if (filtered.specialite_beneficiaire_nom == null) {
										finder_tUniqRow_1.specialite_beneficiaire_nom = null;
									} else {
										finder_tUniqRow_1.specialite_beneficiaire_nom = filtered.specialite_beneficiaire_nom
												.toLowerCase();
									}
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										if (filtered.specialite_beneficiaire_id == null) {
											new_tUniqRow_1.specialite_beneficiaire_id = null;
										} else {
											new_tUniqRow_1.specialite_beneficiaire_id = filtered.specialite_beneficiaire_id
													.toLowerCase();
										}
										if (filtered.specialite_beneficiaire_nom == null) {
											new_tUniqRow_1.specialite_beneficiaire_nom = null;
										} else {
											new_tUniqRow_1.specialite_beneficiaire_nom = filtered.specialite_beneficiaire_nom
													.toLowerCase();
										}
										...
										if (specialites == null) {
											...
											specialites = new specialitesStruct();
										}
										specialites.specialite_beneficiaire_id = filtered.specialite_beneficiaire_id;
										specialites.specialite_beneficiaire_nom = filtered.specialite_beneficiaire_nom;
...
// Start of branch "specialites"
									if (specialites != null) {
										...
										if (execStat) {
											runStat.updateStatOnConnection(iterateId, 1, 1, "specialites");
										}

										row2 = null;
										whetherReject_tDBOutput_1 = false;
										if (specialites.specialite_beneficiaire_id == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(1, specialites.specialite_beneficiaire_id);
										}

										if (specialites.specialite_beneficiaire_nom == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, specialites.specialite_beneficiaire_nom);
										}
										...
										if (!whetherReject_tDBOutput_1) {
											row2 = new row2Struct();
											row2.specialite_beneficiaire_id = specialites.specialite_beneficiaire_id;
											row2.specialite_beneficiaire_nom = specialites.specialite_beneficiaire_nom;
										}
...
///////////////////////		
											...
											if (row2.specialite_beneficiaire_id != null) { //
												row_tLogRow_1[0] = String.valueOf(row2.specialite_beneficiaire_id);

											} //

											if (row2.specialite_beneficiaire_nom != null) { //
												row_tLogRow_1[1] = String.valueOf(row2.specialite_beneficiaire_nom);
...
///////////////////////    			
							...
							} // End of branch "specialites_remunerations"
...
// ###############################
// # Outputs initialization
				specialites_avantagesStruct specialites_avantages_tmp = new specialites_avantagesStruct();
// ###############################
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.entreprise_identifiant = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.denomination_sociale = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.ligne_identifiant = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_categorie_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.categorie = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_nom = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_prenom = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_qualite_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.qualite = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_adresse1 = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_adresse2 = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_adresse3 = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_adresse4 = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_codepostal = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_ville = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_pays_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.pays = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_titre_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_titre_libelle = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_specialite_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_speicalite_libelle = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_identifiant_type_code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.identifiant_type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_identifiant_valeur = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_etablissement = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_etablissement_codepostal = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_etablissement_ville = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_denomination_sociale = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.benef_objet_social = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.ligne_type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.avant_date_signature = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.avant_montant_ttc = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.avant_nature = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.avant_convention_lie = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									avantages.semestre = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
// Start of branch "avantages"
						if (avantages != null) {
							...
							{ // start of Var scope
								...
								specialites_avantages = null;

// # Output table : 'specialites_avantages'
								specialites_avantages_tmp.specialite_beneficiaire_id = avantages.benef_specialite_code
										.equals("") ? null : avantages.benef_specialite_code;
								specialites_avantages_tmp.specialite_beneficiaire_nom = avantages.benef_speicalite_libelle
										.equals("") ? null : avantages.benef_speicalite_libelle;
								specialites_avantages = specialites_avantages_tmp;
// ###############################
							 ...
							 */
// Start of branch "specialites_avantages"
							if (specialites_avantages != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "specialites_avantages");
								}
...
// for output
								...
								merged.specialite_beneficiaire_id = specialites_avantages.specialite_beneficiaire_id;
								merged.specialite_beneficiaire_nom = specialites_avantages.specialite_beneficiaire_nom;
...
///////////////////////    			
							...
							} // End of branch "specialites_avantages"
...
// ###############################
// # Outputs initialization
				specialites_conventionsStruct specialites_conventions_tmp = new specialites_conventionsStruct();
// ###############################
...
// Start of branch "conventions"
						if (conventions != null) {
							...
							{ // start of Var scope
								...
								specialites_conventions = null;

// # Output table : 'specialites_conventions'
								specialites_conventions_tmp.specialite_beneficiaire_id = conventions.benef_specialite_code
										.equals("") ? null : conventions.benef_specialite_code;
								specialites_conventions_tmp.specialite_beneficiaire_nom = conventions.benef_speicalite_libelle;
								specialites_conventions = specialites_conventions_tmp;
// ###############################
							 ...
							 */
// Start of branch "specialites_conventions"
							if (specialites_conventions != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "specialites_conventions");
								}
...
// for output
								...
								merged.specialite_beneficiaire_id = specialites_conventions.specialite_beneficiaire_id;
								merged.specialite_beneficiaire_nom = specialites_conventions.specialite_beneficiaire_nom;
...
///////////////////////    			
							...
							} // End of branch "specialites_conventions"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "specialites_avantages",
							"specialites_remunerations", "specialites_conventions");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "specialites");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final specialite_beneficiaire_dim specialite_beneficiaire_dimClass = new specialite_beneficiaire_dim();

		int exitCode = specialite_beneficiaire_dimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = specialite_beneficiaire_dim.class.getClassLoader().getResourceAsStream(
					"transparence_sante_bi/specialite_beneficiaire_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = specialite_beneficiaire_dim.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : specialite_beneficiaire_dim");
		}
...
/************************************************************************************************
 * 247861 characters generated by Talend Open Studio for Data Integration on the
 * 7 janvier 2021 03:27:01 CET
 ************************************************************************************************/