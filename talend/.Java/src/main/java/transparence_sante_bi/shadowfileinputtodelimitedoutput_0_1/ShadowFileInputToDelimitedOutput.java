...
package transparence_sante_bi.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TRANSPARENCE_SANTE_BI_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/BI/transparence-sante/talend/TRANSPARENCE_SANTE_BI/temp/preview/rpps_diplomes.csv"))
				...
				String[] headColutFileOutputDelimited = new String[14];
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/BI/transparence-sante/data/others/rpps_diplomes.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								...
								0, limit_tFileInputDelimited, -1, false);
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[14];
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader()
					.getResourceAsStream("transparence_sante_bi/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 48032 characters generated by Talend Open Studio for Data Integration on the
 * 8 octobre 2020 20:29:31 CEST
 ************************************************************************************************/