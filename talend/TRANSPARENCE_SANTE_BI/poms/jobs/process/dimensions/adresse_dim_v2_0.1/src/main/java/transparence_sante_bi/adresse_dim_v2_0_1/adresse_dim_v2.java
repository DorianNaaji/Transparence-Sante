		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Io4UpnS3XMEYg9Elt8l9gOjIls9PSL6URQTxFA==");
...
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "adresses_avantages",
							"adresses_entreprises", "adresses_conventions", "adresses_remuneration");
				}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "adresses_avantages", "adresses_entreprises",
							"adresses_conventions", "adresses_remuneration");
				}
