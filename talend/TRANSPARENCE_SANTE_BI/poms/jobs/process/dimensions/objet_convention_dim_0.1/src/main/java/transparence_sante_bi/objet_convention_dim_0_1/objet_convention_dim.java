...
package transparence_sante_bi.objet_convention_dim_0_1;
...
/**
 * Job: objet_convention_dim Purpose: Remplissage de la dimension des objets de
 * convention.<br>
 * Description: Les manifestations liées à certaines conventions ont un objet.
 * Ils figurent dans cette table. Dans les fichiers csv de base, il y a beaucoup
 * d'objets différents, mal orthographiés et redondants. Faire de l'analyse par
 * mots clés. Voir doc : https://github.com/DorianNaaji/transparence-sante <br>
 * 
 * @author haytham.elghazel@univ-lyon1.fr
 * @version 7.3.1.20200219_1130
 * @status DEV
 */
public class objet_convention_dim implements TalendJob {
	...
	private final String jobName = "objet_convention_dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					objet_convention_dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(objet_convention_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class logsStruct implements routines.system.IPersistableRow<logsStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		...
		public String objet_convention;

		public String getObjet_convention() {
			return this.objet_convention;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.objet_convention_id;
		...
		public boolean equals(Object obj) {
			...
			if (this.objet_convention_id != other.objet_convention_id)
				return false;
		...
		public void copyDataTo(logsStruct other) {
			...
			other.objet_convention = this.objet_convention;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim.length) {
					if (length < 1024 && commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim.length == 0) {
						commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[1024];
					} else {
						commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim, 0, length);
				strReturn = new String(commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TRANSPARENCE_SANTE_BI_objet_convention_dim) {
				...
				try {
					...
					this.objet_convention = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.objet_convention, dos);
		...
		public String toString() {
			...
			sb.append(",objet_convention=" + objet_convention);
			sb.append("]");
		...
		public int compareTo(logsStruct other) {
			...
			returnValue = checkNullsAndCompare(this.objet_convention_id, other.objet_convention_id);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class objetsStruct implements routines.system.IPersistableRow<objetsStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final objetsStruct other = (objetsStruct) obj;
		...
		public void copyDataTo(objetsStruct other) {
		...
		public void copyKeysDataTo(objetsStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(objetsStruct other) {
	...
	public static class objets_cleanedStruct implements routines.system.IPersistableRow<objets_cleanedStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final objets_cleanedStruct other = (objets_cleanedStruct) obj;
		...
		public void copyDataTo(objets_cleanedStruct other) {
		...
		public void copyKeysDataTo(objets_cleanedStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(objets_cleanedStruct other) {
	...
	public static class objets_rawStruct implements routines.system.IPersistableRow<objets_rawStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_objet_convention_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(objets_rawStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				objets_rawStruct objets_raw = new objets_rawStruct();
				objets_cleanedStruct objets_cleaned = new objets_cleanedStruct();
				objetsStruct objets = new objetsStruct();
				...
				util_tLogRow_1.addRow(new String[] { "objet_convention_id", "objet_convention", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "objets");
				}
				...
				String tableName_tDBOutput_1 = "objet_convention_dim";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:5/sBXxhn+4YDy8pH6Inws2XeAWx4+Edhbp23Eg==");
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "objet_convention_dim"
						+ "` (`objet_convention_id`,`objet_convention`) VALUES (?,?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "objets_cleaned");
				}
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "objets_raw");
				}
...
// # Outputs initialization
				objets_cleanedStruct objets_cleaned_tmp = new objets_cleanedStruct();
// ###############################
				...
				try {
					...
					while (limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1 != null
						...
						objets_raw = new objets_rawStruct();
						try {
							...
							if (rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])) {// empty
								...
								objets_raw.entreprise_identifiant = null;

								objets_raw.denomination_sociale = null;

								objets_raw.ligne_identifiant = null;

								objets_raw.ligne_rectification = null;

								objets_raw.benef_categorie_code = null;

								objets_raw.categorie = null;

								objets_raw.benef_nom = null;

								objets_raw.benef_prenom = null;

								objets_raw.benef_qualite_code = null;

								objets_raw.qualite = null;

								objets_raw.benef_adresse1 = null;

								objets_raw.benef_adresse2 = null;

								objets_raw.benef_adresse3 = null;

								objets_raw.benef_adresse4 = null;

								objets_raw.benef_codepostal = null;

								objets_raw.benef_ville = null;

								objets_raw.benef_pays_code = null;

								objets_raw.pays = null;

								objets_raw.benef_titre_code = null;

								objets_raw.benef_titre_libelle = null;

								objets_raw.benef_specialite_code = null;

								objets_raw.benef_speicalite_libelle = null;

								objets_raw.benef_identifiant_type_code = null;

								objets_raw.identifiant_type = null;

								objets_raw.benef_identifiant_valeur = null;

								objets_raw.benef_etablissement = null;

								objets_raw.benef_etablissement_codepostal = null;

								objets_raw.benef_etablissement_ville = null;

								objets_raw.benef_denomination_sociale = null;

								objets_raw.benef_objet_social = null;

								objets_raw.ligne_type = null;

								objets_raw.conv_date_signature = null;

								objets_raw.conv_objet = null;

								objets_raw.conv_objet_autre = null;

								objets_raw.conv_date_debut = null;

								objets_raw.conv_date_fin = null;

								objets_raw.conv_montant_ttc = null;

								objets_raw.conv_manifestation_date = null;

								objets_raw.conv_manifestation_nom = null;

								objets_raw.conv_manifestation_lieu = null;

								objets_raw.conv_manifestation_organisateur = null;
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.entreprise_identifiant = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.denomination_sociale = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.ligne_identifiant = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_categorie_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.categorie = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_nom = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_prenom = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_qualite_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.qualite = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_adresse1 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_adresse2 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_adresse3 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_adresse4 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_codepostal = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_ville = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_pays_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.pays = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_titre_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_titre_libelle = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_specialite_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_speicalite_libelle = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_identifiant_type_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.identifiant_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_identifiant_valeur = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_etablissement = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_etablissement_codepostal = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_etablissement_ville = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_denomination_sociale = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.benef_objet_social = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.ligne_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_date_signature = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_objet = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_objet_autre = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_date_debut = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_date_fin = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_montant_ttc = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_manifestation_date = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_manifestation_nom = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_manifestation_lieu = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									objets_raw.conv_manifestation_organisateur = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
// Start of branch "objets_raw"
						if (objets_raw != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "objets_raw");
							}
							...
							{ // start of Var scope
								...
								Var.normalizedObjetConvention = ObjetConventionIdGenerator
										.normalizeObjetConvention(objets_raw.conv_objet, objets_raw.conv_objet_autre);
								;// ###############################
								// ###############################
								// # Output tables
...
// # Output table : 'objets_cleaned'
								objets_cleaned_tmp.objet_convention_id = ObjetConventionIdGenerator
										.getObjetConventionId(Var.normalizedObjetConvention);
								objets_cleaned_tmp.objet_convention = Var.normalizedObjetConvention;
								objets_cleaned = objets_cleaned_tmp;
// ###############################
							 ...
							 */
// Start of branch "objets_cleaned"
							if (objets_cleaned != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "objets_cleaned");
								}

								objets = null;
								finder_tUniqRow_1.objet_convention_id = objets_cleaned.objet_convention_id;
								finder_tUniqRow_1.hashCodeDirty = true;
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

									new_tUniqRow_1.objet_convention_id = objets_cleaned.objet_convention_id;

									keystUniqRow_1.add(new_tUniqRow_1);
									if (objets == null) {

										objets = new objetsStruct();
									}
									objets.objet_convention_id = objets_cleaned.objet_convention_id;
									objets.objet_convention = objets_cleaned.objet_convention;
...
// Start of branch "objets"
								if (objets != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "objets");
									}

									logs = null;
									whetherReject_tDBOutput_1 = false;
									pstmt_tDBOutput_1.setInt(1, objets.objet_convention_id);

									if (objets.objet_convention == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, objets.objet_convention);
									}
									...
									if (!whetherReject_tDBOutput_1) {
										logs = new logsStruct();
										logs.objet_convention_id = objets.objet_convention_id;
										logs.objet_convention = objets.objet_convention;
									}
...
///////////////////////		
										...
										row_tLogRow_1[0] = String.valueOf(logs.objet_convention_id);

										if (logs.objet_convention != null) { //
											row_tLogRow_1[1] = String.valueOf(logs.objet_convention);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "objets_raw");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "objets_cleaned");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "objets");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final objet_convention_dim objet_convention_dimClass = new objet_convention_dim();

		int exitCode = objet_convention_dimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = objet_convention_dim.class.getClassLoader().getResourceAsStream(
					"transparence_sante_bi/objet_convention_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = objet_convention_dim.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : objet_convention_dim");
		}
...
/************************************************************************************************
 * 113870 characters generated by Talend Open Studio for Data Integration on the
 * 31 janvier 2021 18:29:58 CET
 ************************************************************************************************/