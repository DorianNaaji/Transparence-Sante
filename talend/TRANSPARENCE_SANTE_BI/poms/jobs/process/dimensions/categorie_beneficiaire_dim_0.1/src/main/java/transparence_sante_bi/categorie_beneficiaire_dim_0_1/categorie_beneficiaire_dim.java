...
package transparence_sante_bi.categorie_beneficiaire_dim_0_1;
...
/**
 * Job: categorie_beneficiaire_dim Purpose: remplir la dimension de catégorie
 * des bénéficiaires<br>
 * Description: les bénéficiaires font partie d'une catégorie (voir doc
 ...
 * @status DEV
 */
public class categorie_beneficiaire_dim implements TalendJob {
	...
	private final String jobName = "categorie_beneficiaire_dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					categorie_beneficiaire_dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(categorie_beneficiaire_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class categoriesStruct implements routines.system.IPersistableRow<categoriesStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
	...
	public static class categories_remunerationStruct
			implements routines.system.IPersistableRow<categories_remunerationStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(categories_remunerationStruct other) {
	...
	public static class categories_avantagesStruct
			implements routines.system.IPersistableRow<categories_avantagesStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(categories_avantagesStruct other) {
	...
	public static class categories_conventionsStruct
			implements routines.system.IPersistableRow<categories_conventionsStruct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_BI_categorie_beneficiaire_dim = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(categories_conventionsStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				categories_avantagesStruct categories_avantages = new categories_avantagesStruct();

				conventionsStruct conventions = new conventionsStruct();
				categories_conventionsStruct categories_conventions = new categories_conventionsStruct();
				...
				util_tLogRow_1.addRow(new String[] { "categorie_beneficiaire_id", "categorie_beneficiaire_nom", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "categories");
				}
				...
				String tableName_tDBOutput_2 = "categorie_beneficiaire_dim";
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:uhaRww6icjXx+TFJu7cOAKkEJszZRifPzGTswQ==");
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "categorie_beneficiaire_dim"
						+ "` (`categorie_beneficiaire_id`,`categorie_beneficiaire_nom`) VALUES (?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					String categorie_beneficiaire_id;
					String categorie_beneficiaire_nom;
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.categorie_beneficiaire_id == null) ? 0
									: this.categorie_beneficiaire_id.hashCode());

							result = prime * result + ((this.categorie_beneficiaire_nom == null) ? 0
									: this.categorie_beneficiaire_nom.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.categorie_beneficiaire_id == null) {
							if (other.categorie_beneficiaire_id != null)
								return false;

						} else if (!this.categorie_beneficiaire_id.equals(other.categorie_beneficiaire_id))

							return false;

						if (this.categorie_beneficiaire_nom == null) {
							if (other.categorie_beneficiaire_nom != null)
								return false;

						} else if (!this.categorie_beneficiaire_nom.equals(other.categorie_beneficiaire_nom))
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "categories_conventions",
							"categories_avantages", "categories_remuneration");
				}
...
// # Outputs initialization
				categories_remunerationStruct categories_remuneration_tmp = new categories_remunerationStruct();
// ###############################
...
// Start of branch "remunerations"
						if (remunerations != null) {
							...
							{ // start of Var scope
								...
								categories_remuneration = null;

// # Output table : 'categories_remuneration'
								categories_remuneration_tmp.categorie_beneficiaire_id = remunerations.benef_categorie_code
										.equals("") ? null : remunerations.benef_categorie_code;
								categories_remuneration_tmp.categorie_beneficiaire_nom = remunerations.categorie
										.equals("") ? null : remunerations.categorie;
								categories_remuneration = categories_remuneration_tmp;
// ###############################
							 ...
							 */
// Start of branch "categories_remuneration"
...
//////////
								...
								ope_tFilterRow_1.matches((merged.categorie_beneficiaire_id != null),
										"categorie_beneficiaire_id!=null failed");
								ope_tFilterRow_1.matches((merged.categorie_beneficiaire_nom != null),
										"categorie_beneficiaire_nom!=null failed");

								if (ope_tFilterRow_1.getMatchFlag()) {
									if (filtered == null) {
										filtered = new filteredStruct();
									}
									filtered.categorie_beneficiaire_id = merged.categorie_beneficiaire_id;
									filtered.categorie_beneficiaire_nom = merged.categorie_beneficiaire_nom;
...
// Start of branch "filtered"
								if (filtered != null) {
									...
									categories = null;
									if (filtered.categorie_beneficiaire_id == null) {
										finder_tUniqRow_1.categorie_beneficiaire_id = null;
									} else {
										finder_tUniqRow_1.categorie_beneficiaire_id = filtered.categorie_beneficiaire_id
												.toLowerCase();
									}
									if (filtered.categorie_beneficiaire_nom == null) {
										finder_tUniqRow_1.categorie_beneficiaire_nom = null;
									} else {
										finder_tUniqRow_1.categorie_beneficiaire_nom = filtered.categorie_beneficiaire_nom
												.toLowerCase();
									}
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										if (filtered.categorie_beneficiaire_id == null) {
											...
											new_tUniqRow_1.categorie_beneficiaire_id = filtered.categorie_beneficiaire_id
													.toLowerCase();
										}
										if (filtered.categorie_beneficiaire_nom == null) {
											new_tUniqRow_1.categorie_beneficiaire_nom = null;
										} else {
											new_tUniqRow_1.categorie_beneficiaire_nom = filtered.categorie_beneficiaire_nom
													.toLowerCase();
										}
										...
										categories.categorie_beneficiaire_id = filtered.categorie_beneficiaire_id;
										categories.categorie_beneficiaire_nom = filtered.categorie_beneficiaire_nom;
...
// Start of branch "categories"
									if (categories != null) {
										...
										if (execStat) {
											runStat.updateStatOnConnection(iterateId, 1, 1, "categories");
										}

										row3 = null;
										whetherReject_tDBOutput_2 = false;
										if (categories.categorie_beneficiaire_id == null) {
											pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_2.setString(1, categories.categorie_beneficiaire_id);
										}

										if (categories.categorie_beneficiaire_nom == null) {
											pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_2.setString(2, categories.categorie_beneficiaire_nom);
										}
										...
										if (!whetherReject_tDBOutput_2) {
											row3 = new row3Struct();
											row3.categorie_beneficiaire_id = categories.categorie_beneficiaire_id;
											row3.categorie_beneficiaire_nom = categories.categorie_beneficiaire_nom;
										}
...
///////////////////////		
											...
											if (row3.categorie_beneficiaire_id != null) { //
												row_tLogRow_1[0] = String.valueOf(row3.categorie_beneficiaire_id);

											} //

											if (row3.categorie_beneficiaire_nom != null) { //
												row_tLogRow_1[1] = String.valueOf(row3.categorie_beneficiaire_nom);
...
// ###############################
// # Outputs initialization
				categories_avantagesStruct categories_avantages_tmp = new categories_avantagesStruct();
// ###############################
...
// Start of branch "avantages"
						if (avantages != null) {
							...
							{ // start of Var scope
								...
								categories_avantages = null;

// # Output table : 'categories_avantages'
								categories_avantages_tmp.categorie_beneficiaire_id = avantages.benef_categorie_code
										.equals("") ? null : avantages.benef_categorie_code;
								categories_avantages_tmp.categorie_beneficiaire_nom = avantages.categorie.equals("")
										? null
										: avantages.categorie;
								categories_avantages = categories_avantages_tmp;
// ###############################
							 ...
							 */
// Start of branch "categories_avantages"
							if (categories_avantages != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "categories_avantages");
								}
...
// for output
								...
								merged.categorie_beneficiaire_id = categories_avantages.categorie_beneficiaire_id;
								merged.categorie_beneficiaire_nom = categories_avantages.categorie_beneficiaire_nom;
...
///////////////////////    			
							...
							} // End of branch "categories_avantages"
...
// ###############################
// # Outputs initialization
				categories_conventionsStruct categories_conventions_tmp = new categories_conventionsStruct();
// ###############################
...
// Start of branch "conventions"
						if (conventions != null) {
							...
							{ // start of Var scope
								...
								categories_conventions = null;

// # Output table : 'categories_conventions'
								categories_conventions_tmp.categorie_beneficiaire_id = // categorie code starts with a
																						// '['. Always.
// the code is enclosed between braces like so : [CODE]

										conventions.benef_categorie_code.equals("") ? null
												: conventions.benef_categorie_code.charAt(0) == '['
														&& !conventions.benef_categorie_code.startsWith("[AUTRE]")
																? conventions.benef_categorie_code
																: null;
								categories_conventions_tmp.categorie_beneficiaire_nom = conventions.categorie.equals("")
										? null
										: conventions.categorie;
								categories_conventions = categories_conventions_tmp;
// ###############################
							 ...
							 */
// Start of branch "categories_conventions"
							if (categories_conventions != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "categories_conventions");
								}
...
// for output
								...
								merged.categorie_beneficiaire_id = categories_conventions.categorie_beneficiaire_id;
								merged.categorie_beneficiaire_nom = categories_conventions.categorie_beneficiaire_nom;
...
///////////////////////    			
							...
							} // End of branch "categories_conventions"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "categories_conventions", "categories_avantages",
							"categories_remuneration");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "categories");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final categorie_beneficiaire_dim categorie_beneficiaire_dimClass = new categorie_beneficiaire_dim();

		int exitCode = categorie_beneficiaire_dimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = categorie_beneficiaire_dim.class.getClassLoader().getResourceAsStream(
					"transparence_sante_bi/categorie_beneficiaire_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = categorie_beneficiaire_dim.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : categorie_beneficiaire_dim");
		}
...
/************************************************************************************************
 * 247448 characters generated by Talend Open Studio for Data Integration on the
 * 7 janvier 2021 03:37:41 CET
 ************************************************************************************************/