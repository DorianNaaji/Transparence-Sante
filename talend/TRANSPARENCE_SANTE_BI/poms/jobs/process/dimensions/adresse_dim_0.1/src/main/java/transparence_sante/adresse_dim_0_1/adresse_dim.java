...
package transparence_sante.adresse_dim_0_1;
...
public class adresse_dim implements TalendJob {
	...
	private final String projectName = "TRANSPARENCE_SANTE";
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_TRANSPARENCE_SANTE_adresse_dim = new byte[0];
		static byte[] commonByteArray_TRANSPARENCE_SANTE_adresse_dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRANSPARENCE_SANTE_adresse_dim.length) {
					if (length < 1024 && commonByteArray_TRANSPARENCE_SANTE_adresse_dim.length == 0) {
						commonByteArray_TRANSPARENCE_SANTE_adresse_dim = new byte[1024];
					} else {
						commonByteArray_TRANSPARENCE_SANTE_adresse_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TRANSPARENCE_SANTE_adresse_dim, 0, length);
				strReturn = new String(commonByteArray_TRANSPARENCE_SANTE_adresse_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TRANSPARENCE_SANTE_adresse_dim) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:CfCBNjs8naLy6btTjMLc7i3s6R8VLBJPnqaHwg==");
...
// Start of branch "row2"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = adresse_dim.class.getClassLoader()
					.getResourceAsStream("transparence_sante/adresse_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 284578 characters generated by Talend Open Studio for Data Integration on the
 * 19 janvier 2021 19:38:16 CET
 ************************************************************************************************/