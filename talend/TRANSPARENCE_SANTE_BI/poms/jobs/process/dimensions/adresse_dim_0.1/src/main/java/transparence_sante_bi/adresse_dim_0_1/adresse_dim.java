		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:C0FvZR5uRVmeBU3XTndppnDfDkLdj9w/jyJjeA==");
...
// # Output table : 'adresse'
									adresse_tmp.adresse_id = row1.country_code.concat(row1.postal_code)
											.concat(row1.place_name.replaceAll("[^A-Za-z0-9]", ""));
...
/************************************************************************************************
 * 276987 characters generated by Talend Open Studio for Data Integration on the
 * 20 janvier 2021 10:11:36 CET
 ************************************************************************************************/